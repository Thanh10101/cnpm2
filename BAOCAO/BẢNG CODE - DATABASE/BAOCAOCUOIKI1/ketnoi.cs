...
namespace BAOCAOCUOIKI1
{
    class ketnoi
    {
        SqlConnection cn = new SqlConnection(@"Data Source=LAPTOP-G5S7O1BS\SQLEXPRESS;Initial Catalog=MayBayDB17;Integrated Security=True");
        string chuoiketnoi = @"Data Source=LAPTOP-G5S7O1BS\SQLEXPRESS;Initial Catalog=MayBayDB17;Integrated Security=True";
        public ketnoi()
        {
